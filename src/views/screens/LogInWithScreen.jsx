        ...
        <SafeAreaView>
            <ScrollView contentContainerStyle={style.logIn}>
                ...
                <Text style={style.logInSubTitle}>
                    By clicking Log In, you agree with our <Text style={style.logInTextLink}>Terms</Text>. 
                    Learn how we process your data in our <Text style={style.logInTextLink}>Privacy Policy</Text> and <Text style={style.logInTextLink}>Cookies Policy</Text>.
                </Text>
                <View>
                    {logInBtns.map(e => (
                        e.lastBtn ? 
